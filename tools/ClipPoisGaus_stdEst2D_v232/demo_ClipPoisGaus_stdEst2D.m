...
if 1 %% load "noise-free" image and add noise   (OTHERWISE LOAD RAW DATA, SEE BELOW)
    add_noise=0;                % add noise to image
...
%     y=im2double(imread('y_piecewise.tif'));
    y=im2double(imread('C2-4-DS4-cherry-s100b-3.tif'));    
%     y=im2double(imread('061815 BCP 50nM 488 3.5%750_561 1% 800 0-128.lsm - Ch1-T1 - C1 Z1 T1.tif'));    
