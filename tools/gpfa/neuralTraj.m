...
% INPUTS:
%
% runIdx      - results files will be saved in output/runXXX, where
%               XXX is runIdx
...
% OUTPUTS:
%
% result      - structure containing all variables saved in output/runXXX/
...
%        John Cunningham  jcunnin@stanford.edu
  ...
  runDir = sprintf('output/run%03d', runIdx);
  if isdir(runDir)
