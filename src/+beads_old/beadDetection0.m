function [resBead,resBeadCenter,resBeadRad,beadShow] = beadDetection0(dat0,thr0,thrMulti,rad0,rad1,usePara,outPath)
...
if usePara
    ...
    parfor ii=1:nCC
        ...
        [resBead0,resBeadCenter0,resBeadRad0] = beadMatchMulti( d2, d1, myRef, rga(1), rgb(1), 0, thrMulti);
